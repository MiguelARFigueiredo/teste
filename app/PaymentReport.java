...
public class PaymentReport {
    ...
    // Formato da data utilizado para formatação
    ...
    // Número máximo de chamadas permitidas por dez minutos
    ...
    public static void main(String[] args) {
        ...
        // Timer para agendar a tarefa de geração de relatório
        ...
        // Tarefa a ser executada pelo Timer
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                try {
                    ...
                    PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter("payment_report.csv", true)));
                    ...
                    while (!currentDate.isAfter(endDate)) {
                        ...
                        try {
                            ...
                            if (doesDateExistInFile("payment_report.csv", formattedDate)) {
                                // Se existir, atualiza o valor no ficheiro
                                updateValueInFile("payment_report.csv", formattedDate, formattedValue);
                            } else {
                                // Caso contrário, escreve uma nova entrada no ficheiro
                                writer.printf("%s,%s%n", formattedDate, formattedValue);
                            }

                            // Exibe mensagem de sucesso para a data processada
                            System.out.println("Successfully wrote data for date: " + formattedDate);
                            ...
                            System.err.println("Error fetching data for date " + formattedDate + ": " + e.getMessage());
                        }
                    ...
                    // Fecha o PrintWriter após concluir a escrita no ficheiro
                    writer.close();
        ...
        // Agenda a tarefa para ser executada repetidamente a cada 3000 milissegundos (3 segundos)
    ...
    private static void updateValueInFile(String filename, String date, String value) throws IOException {
        // Cria objetos File para o ficheiro original e temporário
        File inputFile = new File(filename);
        File tempFile = new File("temp.csv");

        // Abre o ficheiro original para leitura e o temporário para escrita
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readLine()) != null) {
                // Se encontrar a linha correspondente à data fornecida, escreve a linha atualizada no ficheiro temporário
                if (line.startsWith(date + ",")) {
                    writer.write(date + "," + value);
                    writer.newLine();
                    dateUpdated = true;
                } else {
                    // Caso contrário, escreve a linha original no ficheiro temporário
                    writer.write(line);
                    writer.newLine();
                }
            }

            // Se a data não foi encontrada no ficheiro original, adiciona ao final do ficheiro temporário
            if (!dateUpdated) {
                writer.write(date + "," + value);
                writer.newLine();
            }
        ...
        // Modifica o ficheiro temporário para substituir o original
