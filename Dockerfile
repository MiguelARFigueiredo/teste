...
# Defina o diretório de trabalho para o projeto play-java-hello-world-tutorial-2.6.x
WORKDIR /play-java-hello-world-tutorial-2.6.x

# Copie o código fonte da sua aplicação para o diretório de trabalho
COPY . .

# Compile e construa o projeto com o SBT na pasta play-java-hello-world-tutorial-2.6.x
...
CMD ["sh", "-c", "rm -f /play-java-hello-world-tutorial-2.6.x/target/universal/stage/RUNNING_PID && $EXECUTABLE_DIR/$EXECUTABLE_FILE -Dplay.http.secret.key=my_secret_key"]
